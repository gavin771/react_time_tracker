            ...
            <div>
                <div className='ui three column centered grid'>
                    <div className='column'>
                        <EditableTimerList timers={this.state.timers} onFormSubmit={this.handleEditFormSubmit} deleteTimer={this.deleteTimer} onStartClick={this.handleStartClick}
        ...
        if (this.state.isOpen) {
            ...
            return (
                <div className='ui basic content center aligned segment'>
                    <button id="add-timer" className='ui basic button icon' onClick={this.handleFormOpen}>
